...
const generateUserWorkout = (goals, experience, availability) => {
    ...
    if (split_type === "Full Body") {
        ...
        //Upper Body Muscles: Chest, Shoulders, Back, Triceps, Biceps lower Body Muscles: Glutes, Quads, Hamstrings, Calves
        split_structure = {
            Day1: {
                "Bench Press": { sets: sets, reps: reps },
                "Overhead Press": { sets: sets, reps: reps },
    ...
    return {split_type,split_structure}
};

module.exports={generateUserWorkout}
